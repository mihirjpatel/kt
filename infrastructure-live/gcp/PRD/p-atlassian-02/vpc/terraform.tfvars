terragrunt = {
  terraform {
    source = "git::git@github.com:artnetworldwide/terraform-modules.git//gcp/modules/shared-vpc?ref=feature/add-version-of-sonicwall-script-with-one-subnet"
...
shared_vpc_project_name = "p-atlassian-02"
